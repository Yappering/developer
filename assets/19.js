                ...
                .then(data => {
                    data.forEach(user => {
                        ...
                        if (params.get("page") === "shop") {
                            ...
                            bannerImage.src = 'https://cdn.discordapp.com/app-assets/1096190356233670716/' + user.banner + '.png?size=4096';
                            bannerImage.alt = user.name;
                
                            const logoImage = category.querySelector("[data-shop-category-logo-image]");
                            logoImage.src = 'https://cdn.discordapp.com/app-assets/1096190356233670716/' + user.logo + '.png?size=4096';
        ...
        document.getElementById("everything-housing-container").innerHTML = `
            ...
            <div style="display: flex; width: 1300px; margin-left: auto; margin-right: auto;" data-shop-output-plus>
                <template data-shop-category-template-plus>
                    <div onclick="location.href='/pplus';" style="width: 550px; margin-left: auto; margin-right: auto; cursor: pointer;">
