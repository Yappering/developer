                        ...
                        for (const apiCategory of data) {
                            if (page === "pplus") {
                                ...
                                if (bopl_battle_banner) {  // Check if element exists
                                    ...
                                    <img class="shop-category-banner-img" src="https://cdn.yapper.shop/assets/22.png">
                                    <div class="shop-category-text-holder">
                                        <p style="font-size: 18px; color: black;">Ready for the chaos that is about to begin.</p>
                                    </div>
                                    `;
                                }
